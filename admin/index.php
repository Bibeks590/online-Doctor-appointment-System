                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="appointment.php" class="non-style-link"><button class="btn-primary btn" style="width:70%">Show all Appointments</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="schedule.php" class="non-style-link"><button class="btn-primary btn" style="width:70%">Show all Sessions</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
